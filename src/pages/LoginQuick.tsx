      ...
      <div className="flex flex-1 items-center px-8.5">
        <div className="w-full">
          ...
          <div className="mb-3 flex flex-col items-center gap-[13px]">
            ...
            <span className="text-sm">{userSaved?.username}</span>
          </div>
          ...
          <button className="mx-auto mt-[30px] flex justify-center gap-2 text-sm text-[var(--main-color)]">
            Switch accounts
          </button>
        </div>
      </div>
      <div className="h-[84px] border-t-[1px] border-gray-800">
        <span className="mt-[18px] block w-full text-center text-[12px]">
          <span className="mr-1 text-gray-600">Don’t have an account?</span>
